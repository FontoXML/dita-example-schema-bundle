...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:mathml="http://www.w3.org/1998/Math/MathML" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="mathml svg">
	...
	<!-- except in all elements that contained and contain mixed content -->
	...
	<!-- All elements that will still be mixed in the new version of the content -->
	...
	<!-- All elements that could contain mixed elements, but no longer should -->
	...
	<!-- The inline elements that can be contained by p -->
	...
	<!-- The inline elements that can be contained by p plus the inline elements that are also block elements -->
